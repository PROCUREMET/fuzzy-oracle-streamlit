...
query = 'select * from TECVERDE.est_pedidosreceb@Tecverde WHERE EXTRACT(YEAR FROM rcb_dt_documento) in (2024, 2025)'
...
#print(df)
df.to_excel('pedidoreceb.xlsx', index=False, engine='openpyxl')
