...
query = 'select pro_in_reduzido, pro_st_descricao, pro_dt_implantacao from TECVERDE.glo_projetos@Tecverde'
...
df.to_excel('glo_projetos.xlsx', index=False, engine='openpyxl')
