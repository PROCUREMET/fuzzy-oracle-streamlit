...
query = 'SELECT * from TECVERDE.EST_PEDCOMPRAS@TECVERDE WHERE EXTRACT(YEAR FROM PDC_DT_EMISSAO) in (2024, 2025)';
...
df.to_excel('est_pdc.xlsx', index=False, engine='openpyxl')
#print(df)
