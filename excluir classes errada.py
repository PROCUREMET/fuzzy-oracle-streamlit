...
query = 'select * from TECVERDE.est_itenssoli@Tecverde WHERE EXTRACT(YEAR FROM SOI_DT_INCLUSAO) in (2024, 2025) and sol_in_codigo != 10428'
...
df.to_excel('excluir classes atualizada.xlsx', index=False, engine='openpyxl')
#print(df)
